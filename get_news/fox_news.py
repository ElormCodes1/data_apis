...
urls = ["https://moxie.foxnews.com/google-publisher/tech.xml", "https://moxie.foxbusiness.com/google-publisher/latest.xml", "https://moxie.foxnews.com/google-publisher/latest.xml"]
for url in urls:
    data = getRSS(url)

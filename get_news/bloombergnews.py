...
urls = ["https://www.bloomberg.com/feeds/technology/sitemap_news.xml", "https://www.bloomberg.com/feeds/bbiz/sitemap_news.xml", "https://www.bloomberg.com/sitemaps/news/latest.xml", "https://www.bloomberg.com/feeds/bpol/sitemap_news.xml"]
for url in urls:
    data = getRSS(url)
